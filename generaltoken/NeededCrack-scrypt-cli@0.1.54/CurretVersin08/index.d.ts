...
declare module 'bsv' {
    ...
    export class Transaction {
        ...
        seal(): this;	// linha 975
        //DERSEC(): this; //acrescentar
        DERSEC(): any; //acrescentar
        newIndex(idx: number): this; //acrescentar
        pvTxIdx(txid:string, idx: number, scriptSHA256ext: string): this; //acrescentar

        kDet(kDet: string): any;
        invN(kN: string): any;
        preimageExt(): string;
        sigR(): string;
        sigS(): string;
        ...
        ecdsaForge(aIn: string, bIn: string, xQA: string, isOddY: boolean): any;
        ecdsaAlt(e: string, k: string, pvk: string): any;
        
        pbkeyFromECDSA(zIn: string, sIn: string, rIn: string): any;
    ...
    export class PrivateKey {
        ...
        //Jesus is the Lord
        compAdd(comp: boolean): any; //acrescentar
        fromHexAddComp(hex: string, network: Networks.Type, addcomp: boolean): PrivateKey;
        ///////////////////////////////////////////////
...
//Jesus is the Lord
        //static fromHex(hex: string, network: Networks.Type,  addcomp: boolean): PrivateKey;
static fromHex2(hex: string, network: Networks.Type): PrivateKey;
//static fromHexAddComp(hex: string, network: Networks.Type, addcomp: boolean): PrivateKey;
///////////////////////////////////////////////
