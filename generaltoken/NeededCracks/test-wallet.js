    ...
    getSignatures(rawTxHex, sigRequests) {
        ...
        const sigResponses = sigRequests.flatMap(sigReq => {
            tx.inputs[sigReq.inputIndex].output = new dist_1.bsv.Transaction.Output({
                ...
                script: sigReq.scriptHex ? new dist_1.bsv.Script(sigReq.scriptHex) : dist_1.bsv.Script.buildPublicKeyHashOut((0, utils_1.parseAddresses)(sigReq.address, this.network)[0]),
                satoshis: sigReq.satoshis
            });
    ...
    listUnspent(address, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.splitFeeTx) {
                ...
                let providerAmount = Math.ceil(((estimateSize + (180 * 1)) / 1000 * feePerKb) - unspentValue);
    ...
    fetchUtxos(targetSatoshis) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (accAmt >= expectedAmt) {
                ...
                const txId = (yield this.signer.signAndsendTransaction(splitTx)).id; // sendTx(splitTx);
