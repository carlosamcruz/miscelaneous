...
const PageSC03OddOrEvenAccept: FC<props1> = (props) => {
  ...
  const writeToChain = async (amount: any) => {
    ...
    else if(!optionP2.current.value || optionP2.current.value < 0 || optionP2.current.value > 10){
      ...
      <div>
        <div style={{ display: 'inline-block', textAlign: 'center', paddingBottom: '20px' }}>
            <label style={{ fontSize: '14px', paddingBottom: '5px' }}  
                > 
                  {/* <input ref={localPvtKey} type="hex" name="PVTKEY1" min="1" defaultValue={'PVT KEY'} placeholder="hex" />*/}
                  <input ref={optionP2} type="number" name="OptionNumber" min="1" placeholder="# from 0 to 10" />
                </label>     
            </div>
        </div>
        ...
        <div style={{ display: 'inline-block', textAlign: 'center', paddingBottom: '20px' }}>
            <label style={{ fontSize: '14px', paddingBottom: '5px' }}  
                > 
                  {/* <input ref={localPvtKey} type="hex" name="PVTKEY1" min="1" defaultValue={'PVT KEY'} placeholder="hex" />*/}
                  <input ref={nBlocks} type="number" name="OptionNumber" min="1" placeholder="+nBlocks(opt)" />
                </label>     
            </div>
        </div>
...
export default PageSC03OddOrEvenAccept;